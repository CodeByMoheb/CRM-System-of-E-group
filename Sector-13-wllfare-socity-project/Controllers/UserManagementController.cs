    ...
    public class UserManagementController : Controller
    {
        ...
        public async Task<IActionResult> CreateTestUsers()
        {
            try
            {
                ...
                var users = new[]
                {
                    new { Email = "admin@sec13.com", UserName = "admin", Role = "Admin", PhoneNumber = "+8801700000001" },
                    new { Email = "president@sec13.com", UserName = "president", Role = "President", PhoneNumber = "+8801700000002" },
                    new { Email = "secretary@sec13.com", UserName = "secretary", Role = "Secretary", PhoneNumber = "+8801700000003" },
                    new { Email = "manager@sec13.com", UserName = "manager", Role = "Manager", PhoneNumber = "+8801700000004" },
                    new { Email = "member@sec13.com", UserName = "member", Role = "Member", PhoneNumber = "+8801700000005" }
                };
