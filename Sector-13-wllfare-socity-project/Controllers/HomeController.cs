...
// In Controllers/HomeController.cs
        ...
        {
            var vm = new MemberDirectoryViewModel
            {
                Buyers = _context.BuyerContacts.OrderByDescending(x => x.CreatedAt).Take(500).ToList(),
                Clients = _context.ClientContacts.OrderByDescending(x => x.CreatedAt).Take(500).ToList()
            };
            return View(vm);
        }
