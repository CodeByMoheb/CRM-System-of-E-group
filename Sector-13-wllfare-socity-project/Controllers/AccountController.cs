            ...
            if (ModelState.IsValid)
            {
                 ...
                 if (model.Email.StartsWith("EMP", StringComparison.OrdinalIgnoreCase))
                 {
                     ...
                     if (employee != null && (VerifyPassword(model.Password, employee.PasswordHash, employee.PasswordSalt) || 
                         (string.IsNullOrEmpty(employee.PasswordHash) && model.Password == "Egroup@1234")))
                     {
                         ...
                         if (employeeUser == null)
                         {
                             ...
                             // Use a default strong password for Identity system
                             var defaultPassword = "Egroup@1234";
                             var createResult = await _userManager.CreateAsync(employeeUser, defaultPassword);
