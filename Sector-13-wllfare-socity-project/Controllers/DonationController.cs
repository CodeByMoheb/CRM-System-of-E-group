...
namespace Sector_13_Welfare_Society___Digital_Management_System.Controllers
{
    public class DonationController : Controller
    {
        ...
        public async Task<IActionResult> PaymentFail()
        {
            try
            {
                var tranId = Request.Form["tran_id"].ToString() ?? string.Empty;
        ...
        public async Task<IActionResult> IPN()
        {
            try
            {
                ...
                var bankTranId = Request.Form["bank_tran_id"].ToString() ?? string.Empty;
                var donorIdStr = Request.Form["value_a"].ToString() ?? string.Empty;
                ...
                if (donor == null)
                {
                    donor = await _context.Donors.FirstOrDefaultAsync(d => 
                        !string.IsNullOrEmpty(d.TransactionId) && 
        ...
        public async Task<IActionResult> PaymentSuccess()
        {
            try
            {
                ...
                var donorIdStr = Request.Form["value_a"].ToString() ?? Request.Query["value_a"].ToString() ?? string.Empty;
