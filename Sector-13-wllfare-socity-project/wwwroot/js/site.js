...
function initializeImageModal() {
    ...
    const aboutImageWrapper = document.querySelector('.image-wrapper[data-bs-toggle="modal"]');
    
    console.log('Initializing image modal...', { imageModal, aboutImageWrapper });
    
    if (imageModal && aboutImageWrapper) {
        // Remove any existing event listeners and re-add
        aboutImageWrapper.removeAttribute('data-bs-toggle');
        aboutImageWrapper.removeAttribute('data-bs-target');
        
        // Manual click handler
        aboutImageWrapper.addEventListener('click', function(e) {
            console.log('Image wrapper clicked, opening modal...');
        ...
        imageModal.addEventListener('show.bs.modal', function() {
            ...
            if (modalImage) {
                console.log('Modal image found:', modalImage);
        ...
        // Add modal shown event listener
        imageModal.addEventListener('shown.bs.modal', function() {
            console.log('Modal shown successfully');
            
            // Add subtle zoom animation to image
            const modalImage = this.querySelector('.modal-body img');
            if (modalImage) {
        ...
        if (modalBody) {
            modalBody.addEventListener('dblclick', function() {
                const modal = bootstrap.Modal.getInstance(imageModal);
                if (modal) modal.hide();
            });
        }
        
        // Ensure modal image loads properly
        ...
        console.error('Modal elements not found:', { imageModal, aboutImageWrapper });
    }
}

// Utility function to handle image zoom in modal
function handleImageZoom(modalId) {
